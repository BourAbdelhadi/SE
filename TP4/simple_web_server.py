...
class myHandler(BaseHTTPRequestHandler):
     ...
     def caesar(text,shift):
	           ...
	           for i in range(0,len(alphabet)):
		                 obj[alphabet[i]]=alphabet[(i+shift)%len(alphabet)]
